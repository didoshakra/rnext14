    ...
    >
      ...
      <div className="mt-2 flex items-center justify-center gap-3">
        ...
        <div className="flex h-10 w-10 items-center justify-center rounded-3xl bg-hBg hover:bg-hBgHov">
          ...
          >
            {" "}
            <path stroke="none" d="M0 0h24v24H0z" /> <circle cx="9" cy="19" r="2" /> <circle cx="17" cy="19" r="2" />{" "}
      ...
      <div className="mb-1 mt-4 flex items-center justify-center gap-10 px-1 font-semibold">
        {item.discontProc > 0 && (
          <p className="justify-center text-center text-base text-hText line-through dark:text-hTextD">
...
export default async function ProductsVeg() {
  ...
  return (
    <section className="flex flex-col space-y-3 px-2 pb-5 pt-5 text-center text-hText dark:text-hTextD">
      ...
      <p>Наші продукти жавжди свіжі і якісні. Ви отримажте масу задоводення від їх споживання</p>
