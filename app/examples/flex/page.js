...
export default function TaillwqindCSS() {
  return (
    ...
    <>
      <h1 className="text-hText dark:text-hTextD bg-fuchsia-200 text-center text-4xl  font-bold">Taillwqind CSS</h1>
      <a
      ...
      <section className="mb-2 h-full w-full">
        <h1 className=" mt-2 text-center text-xl font-bold text-red-600">flex</h1>
        <h1 className="mb-3 text-center  text-sm  font-bold">
          flex justify-center pt-big space-x-0 md:space-x-10 flex-col md:flex-row space-y-5 md:space-y-0
        </h1>
        <div className="pt-big flex  flex-col justify-center space-x-0 space-y-5 md:flex-row md:space-x-10 md:space-y-0">
          <div className="flex justify-center rounded-full bg-red-500 px-4 py-2 hover:bg-red-700">Button1</div>
          <div className="flex justify-center rounded-full bg-red-500 px-4 py-2 hover:bg-red-700">Button2</div>
          <div className="flex justify-center rounded-full bg-red-500 px-4 py-2 hover:bg-red-700">Button3</div>
          <div className="flex justify-center rounded-full bg-red-500 px-4 py-2 hover:bg-red-700">Button4</div>
          <div className="flex justify-center rounded-full bg-red-500 px-4 py-2 hover:bg-red-700">Button5</div>
        </div>
      </section>
      {/*  */}
      <section className="mb-2 h-full w-full">
        <h1 className=" mt-2 text-center text-xl font-bold text-red-600">grid</h1>
        <h1 className="mb-3 text-center  text-sm  font-bold">grid grid-cols-4 gap-4</h1>
      ...
      <section className="mb-2 h-full w-full">
        <h1 className=" mt-2 text-center text-xl font-bold text-red-600">grid</h1>
        <h1 className="mb-3 text-center  text-sm  font-bold">grid grid-cols-3 gap-4</h1>
